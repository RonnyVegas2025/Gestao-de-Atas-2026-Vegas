          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="email" required placeholder="admin@sbs.com.br" value={email} onChange={e => setEmail(e.target.value)}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-3.5 text-slate-300 hover:text-slate-500 transition-colors">
